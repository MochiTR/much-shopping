...
<div class="modal fade" id="exampleModal" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true" ref="modal">
  ...
  <div class="modal-content border-0">
        ...
        <div class="col-sm-8">
          ...
          <div class="row gx-2">
            ...
            <div class="mb-3 col-md-6">
              ...
              <input type="text" class="form-control" id="unit"
                      placeholder="請輸入單位" v-model="temp.unit">
            </div>
          </div>
          ...
          <div class="mb-3">
            ...
            <textarea type="text" class="form-control" id="content"
                      placeholder="請輸入產品說明內容" v-model="temp.content"></textarea>
          </div>
          <div class="mb-3">
            <div class="form-check">
              <input class="form-check-input" type="checkbox"
                      :true-value="1"
                      :false-value="0"
                      id="is_enabled"  v-model="temp.is_enabled">
    ...
    <div class="modal-footer">
      ...
      <button type="button" class="btn btn-primary" @click.prevent="$emit('emit-product',this.temp)">確認</button>
    </div>
  </div>
</div>
</div>
